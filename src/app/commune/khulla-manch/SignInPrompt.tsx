...
export default function SignInPrompt({ isOpen, onClose, message }: SignInPromptProps) {
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl overflow-hidden">
                            ...
                            <div className="relative p-6 pb-4 text-center">
                                ...
                                <p className="text-slate-500 text-sm">
                                    {message || "Sign in to like, comment, and share your voice"}
                                </p>
                            </div>
                            ...
                            <div className="p-6 pt-2 space-y-3">
                                <button
                                    ...
                                    className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white border-2 border-slate-200 rounded-full font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all"
                                >
